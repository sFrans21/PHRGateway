...
namespace APIWHD.Controllers
{
    ...
    public class CalendarController : ControllerBase
    {
        ...
        public CalendarController(IConfiguration configuration, APIDBContext context, IMemoryCache memoryCache, IHttpClientFactory httpClientFactory, SupperAppAPIDBContext supappcontext)
        {
        ...
        /// <summary>
        /// Mengambil daftar semua acara kalender.
        /// </summary> 
        [HttpGet("Getlist")]
        public async Task<IActionResult> GetList()
        {
            if (_memoryCache.TryGetValue("AccessToken", out string accessToken))
            {
                ...
                var result = await _supappcontext.CalendarOfEvents.ToListAsync();
                return Ok(result);
            }
            else
            {
        ...
        /// <summary>
        /// Mengambil detail acara kalender berdasarkan ID.
        /// </summary> 
        [HttpGet]
        [Route("GetById/{Id}")]
        public async Task<IActionResult> GetById(int Id)
        {
            if (_memoryCache.TryGetValue("AccessToken", out string accessToken))
            {
                ...
                var result = await _supappcontext.CalendarOfEvents.Where(a => a.Id == Id).ToListAsync();
                return Ok(result);
            }
            else
            {
